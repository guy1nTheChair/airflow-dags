...
with DAG(dag_id='parallel_dag', schedule_interval='0 0 * * *', default_args=default_args, catchup=False) as dag:
    ...
    tasks = [BashOperator(task_id='task_{0}'.format(t), bash_command='sleep 10'.format(t)) for t in range(1, 4)]
    ...
    task_6 = BashOperator(task_id='task_6', bash_command='sleep 10')
